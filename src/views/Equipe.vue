<template>
  <div class="equipe-page">
    ...
    <CtaSection
      ...
      :subtitle="'Entre em contato e descubra como nossa equipe pode ajudar você a transformar seus dados geoespaciais em insights valiosos.'"
      :stats="[
        { number: '24h', label: 'Resposta Rápida' },
        { number: '100%', label: 'Satisfação' },
        { number: '10+', label: 'Anos de Experiência' },
      ]"
      :primary="{ to: '/contato', label: 'Entre em Contato', icon: 'mdi-phone', color: 'accent' }"
